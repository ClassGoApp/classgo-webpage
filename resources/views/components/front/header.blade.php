                ...
                <div class="col-12">
                    ...
                    @guest
                        <div class="am-loginbtns">
                            <x-multi-currency />
                            <x-multi-lingual />
                            <a href="{{ route('register') }}" class="am-white-btn">{{ __('general.login') }}</a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="am-header_two_wrap">
                        ...
                        <nav class="am-navigation {{ in_array($headerVariation, ['am-header_five', 'am-header_nine']) ? 'navbar-expand-xxl' : 'navbar-expand-xl' }}">
                            <div class="am-navbar-toggler">
                                <div  class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#tenavbar" aria-expanded="false" aria-label="Toggle navigation" role="button">
