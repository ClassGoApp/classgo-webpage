...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <button type="button" class="tb-btn am-insights_btn <?php if(empty($file)): ?> tb-btn_disabled <?php endif; ?> <?php if(!$isPostMaxSizeValid || !$isUploadMaxFilesizeValid): ?> tb-btn_disabled <?php endif; ?>" wire:loading.class="tb-btn_disable" wire:click="upgradeLernen"><?php echo e(__('admin/general.upgrade')); ?></button>
            </form>
...
</div><?php /**PATH /home/vzofynbp/classgoapp.com/resources/views/livewire/pages/admin/upgrade/upgrade.blade.php ENDPATH**/ ?>