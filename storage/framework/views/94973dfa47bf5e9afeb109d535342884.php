                    ...
                    <div class="col-12 col-lg-6 order-2 order-lg-1">
                        <div class="am-content_box am-left-text <?php echo e(pagesetting('select_title_verient')); ?>">
                            ...
                            <?php if(!empty(pagesetting('button_enabled')) && pagesetting('button_enabled') == 'yes'): ?>
                                <?php if(!empty(pagesetting('button_text'))): ?>
                                    <div class="am-mission-button">
                                        <a href="<?php echo e(pagesetting('button_url')); ?>" class="am-btn btn-primary"><?php echo pagesetting('button_text'); ?></a>
                                    </div>  
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
...
</section><?php /**PATH C:\Users\Alejandro\Desktop\classgo\resources\views/pagebuilder/mission/view.blade.php ENDPATH**/ ?>