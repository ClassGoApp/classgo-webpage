                ...
                <div class="am-disputelist_wrap">
                    <div class="am-disputelist am-custom-scrollbar-y">
                        <table class="tb-table <?php if(setting('_general.table_responsive') == 'yes'): ?> tb-table-responsive <?php endif; ?>">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!empty($packages)): ?>
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alias =>$single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td data-label="<?php echo e(__('general.title')); ?>">
                                                <div class="am-list-wrap">
                                                    <figure>
                                                        <img src="<?php echo e(asset('addons/icons/'. $single->image)); ?>" alt="<?php echo e($single->getName()); ?>" width="100"> 
                                                    </figure>
                                                    <span>
                                                        <?php echo $single->getName(); ?>

                                                    </span>
                                                </div>
                                            </td>
                                            <td data-label="<?php echo e(__('general.description')); ?>">
                                                <span><?php echo e(\Illuminate\Support\Str::limit(strip_tags($single->getDescription()), 100)); ?></span>
                                            </td>
                                                        ...
                                                        <div class="am-itemdropdown">
                                                            ...
                                                            <ul class="am-itemdropdown_list dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <!--[if BLOCK]><![endif]--><?php if($single->isDisabled()): ?>
                                                                    <li @click="$wire.dispatch('showConfirm', { id : '<?php echo e($alias); ?>', content: `<?php echo e($single->isEnabled() ? __('admin/general.deactivate_addon') : __('admin/general.activate_addon')); ?>`, type: '<?php echo e($single->isEnabled() ? 'active' : 'disabled'); ?>', action : 'update-status' })">
                                                                ...
                                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                                <li @click="$wire.dispatch('showConfirm', { id: '<?php echo e($alias); ?>', action: 'delete-addon', content: `<?php echo e(__('admin/general.delete_addon_warning')); ?>` })">
                                                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/vzofynbp/classgoapp.com/resources/views/livewire/pages/admin/packages/installed-packages.blade.php ENDPATH**/ ?>