...
<?php endif; ?>
                            <a href="<?php echo e(route('register')); ?>" class="am-white-btn"><?php echo e(__('general.login')); ?></a>
                            <a href="<?php echo e(route('login')); ?>" class="am-btn"><?php echo e(__('general.get_started')); ?></a>
                        </div>
                    <?php endif; ?>
                    </div>
                </div>
...
<?php endif; ?>
                        ...
                        <nav class="am-navigation <?php echo e(in_array($headerVariation, ['am-header_five', 'am-header_nine']) ? 'navbar-expand-xxl' : 'navbar-expand-xl'); ?>">
                            <div class="am-navbar-toggler">
                                <div  class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#tenavbar" aria-expanded="false" aria-label="Toggle navigation" role="button">
...
<?php endif; ?><?php /**PATH C:\Users\Raul\Documents\GitHub\classgo-webpage\resources\views/components/front/header.blade.php ENDPATH**/ ?>